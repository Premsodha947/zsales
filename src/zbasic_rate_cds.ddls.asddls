...
@EndUserText.label: 'basic rate cds'
...
define view entity Zbasic_rate_cds as select from I_BillingDocumentItemPrcgElmnt as a
{
...
where ( a.ConditionType = 'Z3RD' or a.ConditionType = 'ZAFT' or a.ConditionType = 'ZAST' or a.ConditionType = 'ZBSM' or a.ConditionType = 'ZBSW'
